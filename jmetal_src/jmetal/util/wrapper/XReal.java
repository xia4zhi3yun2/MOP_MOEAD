...
///////////////////////////////////////////////////////xia
		else if (type_.getClass().equals(ArrayRealAndBinarySolutionType.class)) 
			return ((ArrayReal)(solution_.getDecisionVariables()[0])).getLength()+((Binary)(solution_.getDecisionVariables()[1])).getNumberOfBits() ;
///////////////////////////////////////////////////////xia	
		else
