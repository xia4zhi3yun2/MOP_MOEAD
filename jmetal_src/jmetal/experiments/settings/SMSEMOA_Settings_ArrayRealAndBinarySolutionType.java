 ...
 */
public class SMSEMOA_Settings_ArrayRealAndBinarySolutionType extends Settings {
   ...
   * @throws JMException 
   */
  public SMSEMOA_Settings_ArrayRealAndBinarySolutionType(String problem) throws JMException {
    super(problem) ;
...
//  if (problem_.getName().compareTo("SpamProblem3D_DeactivateRules") == 0) {
	if (problem_.getSolutionType().getClass().getName().endsWith("ArrayRealAndBinarySolutionType")){
