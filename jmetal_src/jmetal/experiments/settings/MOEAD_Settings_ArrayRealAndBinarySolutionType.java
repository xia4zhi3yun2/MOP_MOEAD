 ...
 */
public class MOEAD_Settings_ArrayRealAndBinarySolutionType extends Settings {
  public double CR_ ;
  public double F_  ;
   ...
   * Constructor
   */
  public MOEAD_Settings_ArrayRealAndBinarySolutionType(String problem) {
    super(problem);
////////////vbasto	    
    //Object [] problemParams = {"Real"};    
    Object [] problemParams = {"ArrayRealAndBinarySolutionType"};    
////////////vbasto	        
    try {
    ...
    // on CEC09 Unconstrained MOP Test Instances Working Report CES-4 91, School 
    // of CS & EE, University of Essex, 02/2009.
    // http://dces.essex.ac.uk/staff/qzhang/MOEAcompetition/CEC09final/code/ZhangMOEADcode/moead0305.rar
//    dataDirectory_ =  "../src/jmetal/MOEADWeightConfiguration" ;
    dataDirectory_ =  "MOEADWeightConfiguration" ;
  } // MOEAD_Settings
...
////////////vbasto	
    double crossoverProbability_ = 0.9; // No NSGAII_Settings_ArrayRealAndBinarySolutionType tem este valor
	parameters.put("realCrossoverProbability", crossoverProbability_) ;
	parameters.put("binaryrossoverProbability", crossoverProbability_) ;  
...
////////////vbasto    
	...
	parameters.put("binaryMutationProbability", mutationProbability_) ;    
