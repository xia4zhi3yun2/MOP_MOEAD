    ...
    try {
      ...
      if (!paretoFrontFile_[problemIndex].equals("")) {
        for (int i = 0; i < numberOfAlgorithms; i++)
		 ...
		 //algorithm[2] = new SMSEMOA_Settings_ArrayRealAndBinarySolutionType(problemName).configure(parameters[2]);
	     parameters[0].put("maxEvaluations_", 25000);
	     parameters[0].put("dataDirectory_", "./src/jmetal/MOEADWeightConfiguration");
	     algorithm[0] = new MOEAD_Settings_ArrayRealAndBinarySolutionType(problemName).configure(parameters[0]);		 
...
//        algorithm[4] = new GDE3_Settings(problemName).configure(parameters[4]);
  ...
  public static void main(String[] args) throws JMException, IOException {
    ...
    exp.experimentName_ = "StandardStudy4D4Algs";
    exp.algorithmNameList_ = new String[]{
                                /*"NSGAII", "SPEA2", "SMSEMOA", */"MOEAD"};
    exp.problemList_ = new String[]{"SpamProblem4D"/*, "ZDT2","ZDT3", "ZDT4","ZDT6",
                                    "WFG1","WFG2","WFG3","WFG4","WFG5","WFG6",
                                    "WFG7","WFG8","WFG9",
                                    "DTLZ1","DTLZ2","DTLZ3","DTLZ4","DTLZ5",
                                    "DTLZ6","DTLZ7"*/};
    exp.paretoFrontFile_ = new String[]{"SpamProblem4D.pf"/*, "ZDT2.pf","ZDT3.pf",
                                    "ZDT4.pf","ZDT6.pf",
...
//    exp.experimentBaseDirectory_ = "/Users/antelverde/Softw/pruebas/jmetal/" + exp.experimentName_;
      exp.experimentBaseDirectory_ = "./jmetal-optimization-output/" + exp.experimentName_;
...
//    exp.paretoFrontDirectory_ = "/Users/antelverde/Softw/pruebas/data/paretoFronts";
      exp.paretoFrontDirectory_ = "./jmetal-optimization-output/paretoFronts";
...
//    exp.independentRuns_ = 100;
    ...
    rows = 1 ;
    columns = 1 ;
    prefix = new String("SpamProblem4D");
    problems = new String[]{"SpamProblem4D"} ;
