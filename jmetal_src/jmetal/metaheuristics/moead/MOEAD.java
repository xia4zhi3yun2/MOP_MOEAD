...
/*     
        ...
        //int rand1=PseudoRandom.randInt(0, populationSize_-1);
        //int rand2=PseudoRandom.randInt(0, populationSize_-1);
        ...
        //parents[0] = (Solution) population_.get(rand1);
        //parents[1] = (Solution) population_.get(rand2);
        
        offsprings=(Solution[]) crossover_.execute(parents);
        
        Solution child=offsprings[PseudoRandom.randInt(0, 1)];
 */       
